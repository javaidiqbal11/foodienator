    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            ...
            <div class="carousel-caption text-left">
                ...
                <a href="<?php echo base_url().'restaurant/index'?>" class="btn btn-primary btn-lg">View Parcels</a>
            </div>
        </div>
...
<div class="container-fluid padding">
    <div class="row text-center welcome">
        ...
        <hr>
        <div class="col-12">
            <p class="lead">The easiest way for your parcels delivery. Pick and Get System provides best delivery
                with in the due time and provide free delivery if order is not on time. So don't wait and start ordering right now!</p>
        </div>
    </div>
</div>
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class="col-xs-12 col-sm-6 col-md-4">
            ...
            <h3>Choose A Franchise</h3>
            <p>First thing you can do is choose from our franchise partners easily!</p>
        </div>
        <div class="col-xs-12 col-sm-6 col-md-4">
            <i class="fas fa-bullseye"></i>
            <h3>Choose A Parcel</h3>
            <p>We've got you covered with various types of parcels from over various delivery franchises online!</p>
        </div>
        <div class="col-sm-12 col-md-4">
        <i class="fas fa-clipboard-check"></i>
            <h3>Pick Up for Delivery</h3>
            <p>After all, the parcel gets delivered as per your choices! and will deliver soon</p>
        </div>
    </div>
    <hr class="my-4">
</div>
<div class="container-fluid padding">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">Popular Parcels</h1>
        </div>
        <hr>
    </div>
</div>
