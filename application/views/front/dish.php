<div class="container p-4">
    <div class="row welcome text-center welcome">
        <div class="col-12">
            <h1 class="display-4">List of <?php echo $res['name']; ?></h1>
        </div>
    </div>
    <div class="container res-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">
                A feast of gorgeousness awaits you with super-seasonal parcels created with love by our wonderful employees.
                </p>
            </div>
        </div>
    </div>
